...
```sh
curl https://us.download.nvidia.com/XFree86/Linux-x86_64/465.31/NVIDIA-Linux-x86_64-465.31.run -o /sources/NVIDIA-Linux-x64_64-465.31.run &&
...
# docs
sudo mkdir   -p /usr/share/doc/nvidia/html              &&
sudo install -vDm644 html/* /usr/share/doc/nvidia/html/ &&
